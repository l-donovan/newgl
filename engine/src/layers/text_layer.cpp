...
void TextLayer::calculate_dimensions() {
    if (glyphs.contains(' ')) {
        ...
        this->columns = ceil(1.0f * Application::width / space_advance);
        this->rows = ceil(1.0f * Application::height / this->font_height);
...
void TextLayer::calculate_attribute_buffers(bool full_draw) {
    ...
    float to_screen_width = 2.0f / Application::width;
    float to_screen_height = 2.0f / Application::height;
